...
const DocumentDetailForOP = ({ document }) => {
		...
		<div className="text-black">
			<div key={document._id}>
				...
				<div className="p-2">
					...
					<Typography variant='paragraph' className='m-3 whitespace-break-spaces text-justify'>{document.endorsementLetter}</Typography>
				</div>
...
export default DocumentDetailForOP;