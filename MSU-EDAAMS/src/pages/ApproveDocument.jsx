...
const ApproveDocument = () => {
  ...
  const currentDocuments = store.documents.slice(
  ...
  return (
    <div className="flex flex-col mx-auto">
      <Typography className="flex mx-auto font-bold text-2xl p-2 ">
        APPROVAL PAGE
      </Typography>
          ...
          <div key={rowIndex} className="grid grid-cols-4 col-span-full ">
            {currentDocuments
              ...
              .map((document) => (
                <div
                  key={document._id}
                  className="flex flex-col p-4 m-2 rounded-lg border border-gray-100 shadow-lg"
                >
                  <DocumentDetail document={document} />
                  <Dialog
                    className="bg-white flex flex-col rounded-xl h-[100vh] overflow-auto"
                    size="lg"
                    open={
                      open &&
                      selectedDocument &&
                  ...
                  >
                    <DialogHeader className="bg-cyan-800 text-white rounded-t-xl">
                    ...
                    <DialogFooter>
                      <div className="flex gap-1.5">
                        <Button
                          ...
                          color="green"
                          onClick={(e) =>
                            handleApproveDocument(e, document._id)
                          }
                        >
                          Approve Document
                        </Button>
                        <Button
                          ...
                          variant="text"
                          color="red"
                          onClick={(e) => handleRejectDocument(e, document._id)}
                        >
                          Reject Document
                        </Button>
                        <Input
      ...
      <div className="flex flex-row place-content-center mx-auto p-4 gap-1.5 ">
        ...
        <Button
          ...
          onClick={nextPage}
          disabled={
            currentPage === Math.ceil(store.documents.length / documentsPerPage)
          }
        >
          Next
        </Button>
