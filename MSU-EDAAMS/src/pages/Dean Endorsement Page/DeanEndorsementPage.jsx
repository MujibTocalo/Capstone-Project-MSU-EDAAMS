            ...
            <DialogFooter>
              <div className="flex gap-4">
                ...
                <Dialog
                  ...
                  open={
                    endorse &&
                    endorseSelectedDocument &&
                    endorseSelectedDocument._id === document._id
                  }
                  handler={() => setEndorse(false)}
                >
                  <div className="flex items-center justify-between">
                    <DialogHeader className="flex w-[100%] bg-indigo-900 ">
                      <Typography className="flex mx-auto font-semibold text-2xl text-white">
                        {" "}
                        Dean Endorsement
                      </Typography>
                    </DialogHeader>
                  ...
                  <DialogFooter className="space-x-2">
                    ...
                    <Button
                      variant="outlined"
                      color="red"
                      onClick={() => setEndorse(false) && setOpen(false)}
                    >
                      close
                    </Button>
                  </DialogFooter>
