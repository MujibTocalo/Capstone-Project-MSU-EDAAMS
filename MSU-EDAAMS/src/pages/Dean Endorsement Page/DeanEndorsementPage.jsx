	...
	return (
		<div className='grid grid-cols-4 w-screen overflow-y-scroll'>
			{pendingDocuments.map((document) => (
				<div key={document._id} className='flex flex-col flex-wrap bg-indigo-100/50 m-1 p-1 rounded-lg shadow-md hover:scale-105'>
					...
					<div className='flex flex-row items-center justify-center'>
						<Button className='flex flex-col whitespace-pre items-center text-black font-medium m-2 hover:font-semibold hover:scale-105'
							size='sm'
							color='white'
							variant='text'
