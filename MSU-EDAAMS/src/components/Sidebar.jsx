  ...
  return (
    <div className="flex flex-col bg-[#0C356A] duration-500 justify-evenly">
      ...
      <div className="flex flex-col bg-[#0C356A] text-white items-center duration-500 p-2">
        ...
        <div
          className={`flex flex-col items-center whitespace-pre p-2 ${
            open ? "relative" : "inherent"
          }`}
        >
          <Typography
            className={`flex text-base font-semibold justify-center ${
              !open && " hidden"
            } ease-in-out`}
          >
            {currentUser}
          ...
          <Typography
            className={`flex text-sm font-normal justify-center ${
              !open && "hidden"
            } ease-in-out`}
          >
            {userDesignation}
